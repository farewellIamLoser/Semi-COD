...
def prompt_generation(model, val_loader, i):
    # pretrain = r'/mnt/e/Mr.Wu/codes/Semi-Supervised-Camouflaged-Object-Detection-with-Scribble-Annotations-main/out/trained/camo_mamba_404_nocate_0.0336.pth'
    #
...
def train(Dataset, net, cfg1, cfg2, cfg3, prompt, train_loss, start_from = 0):
    ...
    val_cfg1 = [Dataset.Config(datapath=f'{root}/TestDataset/{i}', mode='test') for i in ['COD10K']]
    ...
    val_cfg2 = [Dataset.Config(datapath=f'{root}/TestDataset/{i}', mode='test') for i in ['COD10K']]
...
if __name__=='__main__':
    def parse_args():
        ...
        parser.add_argument('--pretrain', type=str,
                            default=r'/mnt/e/Mr.Wu/codes/Semi-Supervised-Camouflaged-Object-Detection-with-Scribble-Annotations-main/out/trained/600.pth',
