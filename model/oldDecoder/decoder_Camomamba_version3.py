...
class SFTA(nn.Module):
    ...
    def forward(self, x, y):
        ...
        hidden_states_x = rms_norm_fn(
            self.drop_path(hidden_states_x),
        ...
        hidden_states_y = rms_norm_fn(
            self.drop_path(hidden_states_y),
        ...
        hidden_states_xy = hidden_states_x * (1 - states_y)
        hidden_states_yx = hidden_states_y * (1 - states_x)
        ...
        hidden_states_xy = rms_norm_fn(
            self.drop_path(hidden_states_xy),
        ...
        hidden_states_yx = rms_norm_fn(
            self.drop_path(hidden_states_yx),
        ...
        hidden_states_final = rms_norm_fn(
            self.drop_path(hidden_states_final),
...
class Decoder(nn.Module):
    def __init__(self, channels):
        ...
        img_sizes = 320
        output_img_sizes = 322

        self.pyramid_pooling = PyramidPooling(512, channels)
        self.sfa1 = SFTA(512, channels, channels, img_size=img_sizes, output_img_size=output_img_sizes, stride=1,
                         is_fisrt_cls=True)
        self.sfa2 = SFTA(320, channels, channels, img_size=img_sizes, output_img_size=output_img_sizes, stride=1,
                         in_pos=17, out_pos=82, is_fisrt_cls=False)
        self.sfa3 = SFTA(128, channels, channels, img_size=img_sizes, output_img_size=output_img_sizes, stride=1,
                         in_pos=82, out_pos=362, is_fisrt_cls=False)
        self.sfa4 = SFTA(64, channels, channels, img_size=img_sizes, output_img_size=output_img_sizes, stride=1,
        ...
        self.up5 = nn.UpsamplingBilinear2d(scale_factor=32)
