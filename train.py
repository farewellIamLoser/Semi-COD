    ...
    for epoch in range(start_from, total_epoch):
        ...
        if epoch < cfg1.epoch:
            ...
            if (epoch + 1) % cfg1.epoch == 0:
                # torch.save(net.state_dict(), cfg1.savepath + '/41cnn_nosam.pth')
                # torch.save(optimizer1.state_dict(), cfg1.savepath + '/41optimizer_cnn_nosam.pth')
...
if __name__=='__main__':
    def parse_args():
        ...
        parser.add_argument('--pretrain', type=str,
                            ...
                            default=r'/mnt/e/Mr.Wu/codes/Semi-Supervised-Camouflaged-Object-Detection-with-Scribble-Annotations-main/out/trained/41_t=9.pth',
